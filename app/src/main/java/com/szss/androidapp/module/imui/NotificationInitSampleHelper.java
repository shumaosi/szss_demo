...
public class NotificationInitSampleHelper extends IMNotification {
	...
	public static void init() {
		if (IMUtil.mIMKit != null) {
			...
			//设置是否开启通知提醒
			IMUtil.mIMKit.setEnableNotification(true);
...
//        intent.setClass(SzssApp.getInstance().getApplicationContext(), LauncherActivity.class);
...
//        return intent;
	...
	public String getAppName() {
		return SzssApp.getInstance().getApplicationContext().getString(R.string.app_name);
	}
