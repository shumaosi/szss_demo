...
package com.szss.androidapp.module.barcode.camera;
...
public class CameraManager {
	...
	public boolean isLightOn() {
		if (camera != null) {
			...
			return Parameters.FLASH_MODE_TORCH.equalsIgnoreCase(parameter.getFlashMode());
		} else {
			return false;
		}
	}

	// openPhotoFlash 是开启闪光灯
	public void openPhotoFlash() {
		if (camera != null) {
			Parameters parameter = camera.getParameters();
	...
	// offPhotoFlash 是关闭闪光灯
	public void offPhotoFlash() {
		if (camera != null) {
			Parameters parameter = camera.getParameters();
