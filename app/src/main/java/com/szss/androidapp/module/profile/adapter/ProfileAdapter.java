package com.szss.androidapp.module.profile.adapter;
	...
	public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
		...
		holder.itemView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				} else if (itemType == TYPE_SETTING) {
					if (mProfileActionClickListener != null) {
						mProfileActionClickListener.profileActionClick(ActionName.ProfilePage_SettingAction, null);
					}
				}
			}
		});
